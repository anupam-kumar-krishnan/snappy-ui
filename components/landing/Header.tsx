import { ArrowUpRight, FlameIcon, PartyPopper } from "lucide-react";
            ...
            >
              <div className="relative z-10 flex items-center justify-between w-full gap-2">
                ...
                <div className="flex items-center gap-6">
                  ...
                  <span className="text-zinc-100 dark:text-zinc-700">|</span>

                  {/* Desktop Navigation */}
                  <div className="hidden sm:flex items-center gap-4">
                    <ViewTransitionsLink
                      href={"/docs/components/background-paths"}
                      className="text-sm text-zinc-600 hover-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-100 transition-colors"
                    >
                      Components
                    </ViewTransitionsLink>
                    <ViewTransitionsLink
                    ...
                    <Link
                      href={"#"}
                      target="_blank"
                      className="text-sm text-zinc-600 hover-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-100 transition-colors flex items-center gap-2"
                    >
                      Templates
