          ...
          <div className="flex items-center justify-center w-full flex-col">
            <div
              className={`
                        ...
                        `}
            >
              <div className="relative z-10 flex items-center justify-between w-full gap-2 h-7">
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div className="hidden sm:flex items-center gap-4">
                    ...
                    >
                      Templates
                      <span className="text-white dark:text-green-600 border border-green-600 bg-green-300 dark:border-green-400 rounded-sm px-1.5 py-0.6 text-xs">
                        New
                      </span>
                    </Link>
                  </div>
                ...
                <div className="flex sm:hidden items-center gap-4">
                  <ViewTransitionsLink
                    href="/docs"
                    className="text-sm text-zinc-600 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-100 transition-colors cursor-pointer"
                  >
                    Components
                  </ViewTransitionsLink>
                  <ViewTransitionsLink
