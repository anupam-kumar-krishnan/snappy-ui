...
export default function List05() {
  return (
    ...
    >
      <div className="relative h-48 bg-linear-to-b from-indigo-500 to-indigo-600 p-6">
        <div className="absolute inset-0 bg-black/20" />
        <div className="relative flex items-end h-full">
          <div className="flex items-center gap-6">
            <div className="w-24 h-24 rounded-2xl shadow-lg overflow-hidden">
              <img
                src="https://a10.gaanacdn.com/gn_img/artists/Dk9KNk23Bx/k9KNqJJbBx/size_m_1739172212.jpg"
                alt="Featured Album"
      ...
      <div className="divide-y divide-zinc-200 dark:divide-zinc-800">
        <div className="group flex items-center gap-4 px-6 py-3 hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors">
          <div className="w-10 h-10 rounded-lg overflow-hidden">
            <img
              src="https://i.ytimg.com/vi/i1o1p_DD6TU/maxresdefault.jpg"
              alt="Album cover"
              className="w-full h-full object-cover"
            />
          </div>
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-zinc-500 dark:text-zinc-400">
              Film: Dhurandar - Singer: Arijit Singh
            </p>
          </div>
